...
# ==============================================================================
#
# 이 파일은 acceptance-criteria.md의 인수 테스트 대상 선정 기준에 따라
# 작성된 시나리오만 포함합니다.
#
# 인수 테스트 대상 선정 기준:
#   1. 비개발자(기획자, QA)가 검증 가능한가?
#   2. 사용자 시나리오로 표현 가능한가?
#   3. API 경계에서 관찰 가능한가?
#
# 포함된 Feature (인수 테스트 대상):
#   - Priority 1: 프로젝트 검색 성능
#   - Priority 2: 멤버 추가 및 동시성 제어
#   - Priority 3: 프로젝트 지원 승인 및 거절
#   - Priority 5: 파일 업로드
#
# 제외된 Feature (단위/통합 테스트 대상):
#   - Priority 4: 인증 및 환경 설정 → 배포/설정은 개발자 영역, 사용자 관찰 불가
#
# ==============================================================================
