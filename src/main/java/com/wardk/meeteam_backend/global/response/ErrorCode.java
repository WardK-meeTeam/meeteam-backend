...
public enum ErrorCode {
    ...
    PROJECT_ALREADY_COMPLETED(HttpStatus.BAD_REQUEST, "PROJECT400", "종료된 프로젝트입니다."),
    ...
    PROJECT_MEMBER_FORBIDDEN(HttpStatus.FORBIDDEN, "PROJECT_MEMBER403", "해당 프로젝트 관리 권한이 없습니다."),
