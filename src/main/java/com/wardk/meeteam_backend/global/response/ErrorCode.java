...
public enum ErrorCode {
    ...
    RECRUITMENT_ALREADY_COMPLETED(HttpStatus.BAD_REQUEST, "PROJECT400", "이미 모집이 완료된 프로젝트입니다."),
    INVALID_RECRUITMENT_COUNT(HttpStatus.BAD_REQUEST, "PROJECT400", "모집 인원은 0 이상이어야 합니다."),
