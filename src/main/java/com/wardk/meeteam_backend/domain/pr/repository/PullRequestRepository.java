...
public interface PullRequestRepository extends JpaRepository<PullRequest, Long> {
    ...
    @Query("SELECT pr FROM PullRequest pr JOIN FETCH pr.projectRepo repo LEFT JOIN FETCH pr.files WHERE repo.repoFullName = :repoFullName")
    List<PullRequest> findAllByRepoFullNameWithFiles(String repoFullName);
}
